...
Future<String> getUrlFromCodec(ui.Codec codec) async {
  // Get the image object from the codec
  final frame = await codec.getNextFrame();

  // Get the byte data from the image object
  ...
  final base64String = base64.encode(uint8List);

  // Use the base64 string as the URL
  final url = 'data:image/png;base64,$base64String';
