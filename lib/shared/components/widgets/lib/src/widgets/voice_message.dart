...
import 'package:albausalah_app/shared/components/widgets/lib/helpers/widgets.dart';
import 'package:albausalah_app/shared/components/widgets/lib/src/widgets/contact_noises.dart';
...
class VoiceMessage extends StatefulWidget {
  VoiceMessage({
    ...
    this.waveForm,
    this.noiseCount = 27,
    this.meBgColor = const Color(0xFF77BC1F),
    this.contactBgColor = const Color(0xFF679E1C),
    this.contactFgColor = Colors.white,
    this.contactCircleColor = Colors.white,
    this.mePlayIconColor = Colors.black,
    this.contactPlayIconColor = Colors.black,
    this.radius = 12,
    this.contactPlayIconBgColor = const Color(0xffffffff),
