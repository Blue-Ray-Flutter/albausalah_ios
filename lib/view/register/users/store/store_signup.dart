                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              children: [
                                Expanded(
                                  child: RadioListTile(
                                    ...
                                    value: 1,
                                    groupValue:
                                        controller.selectedValueStoreType.value,
                                    onChanged: (value) {
                                      controller.selectedValueStoreType.value =
                                          value!;
                                    },
                                ...
                                Expanded(
                                  child: RadioListTile(
                                    ...
                                    groupValue: controller
                                        .selectedValueDeliveryType.value,
                                    onChanged: (value) {
                                      controller.selectedValueDeliveryType
                                          .value = value!;
                                    },
                                  ),
                                ),
                          ...
                          const SizedBox(
                           ...
                           Text(
                            'Services/products offered by the store *'.tr,
                            style: const TextStyle(
                              color: Colors.black,
                              fontSize: 15,
                              fontWeight: FontWeight.bold,
                                ...
                                onTap: (startLoading, stopLoading,
                                  ...
                                  if (controller.formKey.currentState!
                                    ...
                                    if (controller.withFaceSocial.value) {
                                      ...
                                      controller.registerStoreWithSocial(
                          ...
                          Padding(
                            ...
                            child: IconButtonWidget(
                              ...
                              title: 'Create account with facebook'.tr,
                              onTap: () {
