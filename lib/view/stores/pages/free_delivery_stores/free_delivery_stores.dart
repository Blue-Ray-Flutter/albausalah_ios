...
import 'controller/free_delivery_controller.dart';

class FreeDeliveryStores extends GetWidget<FreeDeliveryController> {
  const FreeDeliveryStores({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        return controller.freeDeliveryStoresModel.value == null
            ? Center(
            ...
            : Stack(
                children: [
                  Padding(
                    ...
                    child: Obx(
                      () => controller
                              .freeDeliveryStoresModel.value!.stores!.isEmpty
                          ? Center(
                              child: Text(
                          ...
                          : SizedBox(
                              child: GridView.builder(
                                ...
                                itemCount: controller.freeDeliveryStoresModel
                                    .value!.stores!.length,
                                itemBuilder: (context, index) {
                                  return StoreItem(
                                    isAuthenticated: controller
                                                    .freeDeliveryStoresModel
                                                    .value!
                                                    .stores![index]
                                                    .authenticatedStatus ==
                                                null ||
                                                        ...
                                                        content: Padding(
                                                          padding:
                                                              const EdgeInsets
                                                                  .all(8.0),
                                                          child: Text(
                                                            'Do you want to follow this store'.tr
                                                                .tr,
                                                            style:
                                                                const TextStyle(
                                                              fontSize: 16,
                                    ...
                                    heightContainer: 150,
                                    nameShop: controller.freeDeliveryStoresModel
                                        .value!.stores![index].storeName,
                                    location: controller.freeDeliveryStoresModel
                                        .value!.stores![index].storeLocation,
                                    image: controller.freeDeliveryStoresModel
                                    ...
                                    onTap: () {
                                      Get.to(() => const StorePage(),
                                          arguments: [
                                            controller.freeDeliveryStoresModel
                      ...
                      children: [
                        Expanded(
                          child: DefaultFormField(
                            ...
                            onSubmit: (value) {},
                            onChange: (value) {
                              controller.getFreeDeliveryStores(search: value);
                            },
