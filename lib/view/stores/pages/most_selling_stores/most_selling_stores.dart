...
import 'controller/most_selling_controller.dart';

class MostSellingStores extends GetWidget<MostSellingController> {
  const MostSellingStores({Key? key}) : super(key: key);
                      ...
                      children: [
                        Expanded(
                          child: DefaultFormField(
                            ...
                            onSubmit: (value) {},
                            onChange: (value) {
                              controller.getMostSellingStores(search: value);
                            },
