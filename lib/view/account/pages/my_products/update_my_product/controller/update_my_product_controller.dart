...
class UpdateMyProductController extends GetxController {
  ...
  // RxList<bool> checkedColor = RxList<bool>([]);
  // RxList<bool> checkedSize = RxList<bool>([]);
  ...
  updateMyProduct() async {
    try {
      httpRepository.updateMyProduct(
