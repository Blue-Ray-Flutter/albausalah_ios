...
import 'controller/update_my_job_controller.dart';

class UpdateMyJob extends GetWidget<UpdateMyJobController> {
  const UpdateMyJob({Key? key}) : super(key: key);
