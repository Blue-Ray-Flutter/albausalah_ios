...
import 'controller/upgrade_my_profile_controller.dart';

class UpgradeMyProfile extends GetWidget<UpgradeMyProfileController> {
  const UpgradeMyProfile({Key? key}) : super(key: key);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                // controller.myInformationModel.value!.userData!
                                //             .profilePhotoUrl !=
                                //         null
                                //     ? Container(
                                //         width: 100,
                          ...
                          DefaultFormField(
                            validator: (description) {
                              if (description == null || description.isEmpty) {
                                return 'Description Name is required'.tr;
                              }
                              return null;
                            },
                          ...
                          const SizedBox(
                           ...
                           Text(
                            'Location (Click on button to give your current location)'.tr,
                            style: const TextStyle(
                              color: Colors.black,
                              fontSize: 15,
                              fontWeight: FontWeight.bold,
                          ...
                          Padding(
                            ...
                            child: Center(
                              child: LoadingButton(
                                ...
                                primaryColor: AppColor.globalDefaultColor,
                            ...
                            child: ArgonButton(
                              ...
                              onTap:
                                ...
                                if (controller.formKey.currentState!
                                  ...
                                  await controller.upgradeMyProfile();
                                  controller.btnController.reset();
                                  await stopLoading();
                                } else {
                                  Get.snackbar(
